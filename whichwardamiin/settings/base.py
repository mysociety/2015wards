# Django settings for whichwardamiin project.
...
ROOT_URLCONF = 'whichwardamiin.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'whichwardamiin.wsgi.application'
...
TEMPLATE_CONTEXT_PROCESSORS = global_settings.TEMPLATE_CONTEXT_PROCESSORS + (
    ...
    "whichwardamiin.context_processors.add_settings",
)
